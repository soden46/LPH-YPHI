@extends('layouts.home.master', [
    'title' => '500 | Yayasan Produk Halal Indonesia',
    'pageTitle' => '500 | Yayasan Produk Halal Indonesia',
])
@section('content')
        ...
        <div class="px-40 py-20 bg-white rounded-md shadow-xl">
            <div class="flex flex-col items-center">
                ...
                <h6 class="mb-2 text-2xl font-bold text-center text-gray-800 md:text-3xl">
                    <span class="text-red-500">Oops!</span> Internal Server Error - Yayasan Produk Halal Indonesia
                </h6>
                <p class="mb-8 text-center text-gray-500 md:text-lg">
                    Ada Kesalahan Teknis Pada Server.
                </p>
                <a href="{{ url()->previous() }}"

@extends('layouts.home.error', [
    'title' => '403 | Yayasan Produk Halal Indonesia',
    'pageTitle' => '403 | Yayasan Produk Halal Indonesia',
])
@section('content')
        ...
        <div class="px-40 py-20 bg-white rounded-md shadow-xl">
            <div class="flex flex-col items-center">
                ...
                <h6 class="mb-2 text-2xl font-bold text-center text-gray-800 md:text-3xl">
                    <span class="text-red-500">Forbidden!</span> Anda Tidak Memiliki Akses Ke Halaman Ini - Yayasan Produk
                    Halal Indonesia
                </h6>
